...
public final class Constants {
    ...
    static {
        ...
        locations.put("22 đường số 7", new double[]{16.068713764354753, 108.20724000440931});
        locations.put("22 street no 7", new double[]{16.068713764354753, 108.20724000440931});

        locations.put("choco studio", new double[]{16.07741467617156, 108.20672829414758});
